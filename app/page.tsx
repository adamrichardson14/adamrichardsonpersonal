...
export default function Home() {
  return (
    <main className="">
      <Container>
        <header className="flex mt-10 py-10">
          <h1 className="text-8xl font-semibold text-white vertical-text-custom whitespace-nowrap">
            Adam Richardson
          </h1>
          <div className="ml-8 mt-10">
            ...
            <SocialWhiteLinks className="flex space-x-10 py-16" size={35} />
            <div className="mt-10">
              ...
              <div className="grid grid-cols-3 gap-4 mt-4">
                ...
                <div className="relative w-full rounded-lg border-l-2 border-b-2 border-gray-800 p-3">
                  ...
                  Learn Remix - Full Stack AI Writing assistant built with Remix.js.
                  </h3>
                  <div className="flex justify-between">
                    <Link
                      href="/"
